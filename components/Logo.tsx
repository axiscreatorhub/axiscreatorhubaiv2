  ...
  return (
    <div className={`flex items-center gap-4 select-none ${className}`}>
      <div className={`aspect-square ${size === 'sm' ? 'h-8' : size === 'md' ? 'h-10' : 'h-16'} relative`}>
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-500 to-cyan-500 rounded-2xl flex items-center justify-center shadow-2xl overflow-hidden group">
      ...
      {withText && (
        <div className="flex flex-col leading-none">
          ...
          <span className="text-indigo-400 font-bold text-[7px] tracking-[0.4em] uppercase -mt-0.5 ml-1 opacity-70">
            Digital Life
          </span>
        </div>
      )}
